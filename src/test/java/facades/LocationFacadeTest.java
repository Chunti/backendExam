...
//        Remove any data after each test was run
    ...
    public void testGetLocation() throws Exception {
        Location location = locationFacade.getLocation("Skinderskovvej 31");

        assertEquals(location.getCity(), "2730 Herlev");

    }

    @Test
    public void testGetLocations() throws Exception {
        List<Location> location = locationFacade.getLocations();

        assertEquals(location.size(), 2);

    }

    @Test
    public void testCreateLocation() throws Exception {
        Location location = locationFacade.createLocation("TestAddress", "TestCity", "TestCondition");


        assertEquals(location.getAddress(), "TestAddress");
        assertEquals(location.getCity(), "TestCity");
        assertEquals(location.getCondition(), "TestCondition");
